...
var cfGetServerTime = function cfGetServerTime(r) {
  ...
  if (serverTiming) {
    var re = serverTiming.match(/(?:^|;)\s*dur=([0-9.]+)/);
    if (re) return +re[1];
  }
};
...
var BandwidthMeasurementEngine = /*#__PURE__*/function () {
  function BandwidthMeasurementEngine(_measurements2) {
     ...
     */
    _classPrivateFieldInitSpec(this, _currentAbortController, undefined);
...
function _saveMeasurementResults(measIdx, measTiming) {
  var _this2 = this;
  var _classPrivateFieldGet3 = _classPrivateFieldGet2(_measurements, this)[measIdx],
    bytes = _classPrivateFieldGet3.bytes,
    dir = _classPrivateFieldGet3.dir;
